...
export const TeamFilterModal = (props) => {
    ...
    if (oriPagedata) {
      if (employeeupdateData.length > 0) {
        ...
        localArray = oriPagedata.map((item) => ({
          ...item,
          checked: employeeupdateData.includes(item.teamName),
        }));
      } else {
        console.log("2");
